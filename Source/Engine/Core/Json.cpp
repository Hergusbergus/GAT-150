...
namespace kiko {
	...
	bool kiko::Json::Load(const std::string& filename, rapidjson::Document& document)
	{
		std::string buffer;
	...
	bool kiko::Json::Read(const rapidjson::Value& value, const std::string& name, int& data, bool required)
	{
